...
class ArticuloObtenerArticuloAdicionalController extends Controller
{
    ...
    public function obtenerArticuloAdicional($fabrica, $codigo, $adicional, $clicod, $BanderaVen, $cli_categoria)
    {
        try {
            ...
            if ($total === 0) {
                return $this->apiResponse->notFound('No se encontraron artículos adicionales.');
            }

            $articulo = collect($this->articuloService->obtenerArticuloAdicional($hostIMG, $this->obtenerPrecio($BanderaVen, $clicod), $cli_categoria, $fabrica, $codigo, $adicional));
